"""Autoresearch pretraining (single GPU). Usage: uv run train.py."""
...
# Hyperparameters (edit here; no CLI)
ASPECT_RATIO = 64
HEAD_DIM = 128
WINDOW_PATTERN = "SSSL"
TOTAL_BATCH_SIZE = 2**19
EMBEDDING_LR = 0.6
VALUE_EMBEDDING_LR = 0.55
UNEMBEDDING_LR = 0.004
MATRIX_LR = 0.045
SCALAR_LR = 0.5
WEIGHT_DECAY = 0.2
ADAM_BETAS = (0.78, 0.95)
WARMUP_RATIO = 0.0
WARMDOWN_RATIO = 0.47
FINAL_LR_FRAC = 0.03142
GRAD_CLIP_NORM = 1.08
DEPTH = 8
