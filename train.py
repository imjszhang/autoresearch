...
class GPT(nn.Module):
    ...
    def _precompute_rotary_embeddings(self, seq_len, head_dim, base=447000, device=None):
        if device is None:
...
# Optimization
TOTAL_BATCH_SIZE = 2**18 # ~262K tokens per optimizer step; more outer steps per wall-clock second
