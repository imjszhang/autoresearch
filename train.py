...
MATRIX_LR = 0.04421     # Muon LR; +0.00003 vs 8bc55d5 (smaller global batch 2**18)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.2      # cautious weight decay for Muon
ADAM_BETAS = (0.8, 0.94) # Adam beta1, beta2 (beta2 0.94: slightly faster second-moment decay vs 0.95)
WARMUP_RATIO = 0.0      # fraction of time budget for LR warmup
WARMDOWN_RATIO = 0.5    # fraction of time budget for LR warmdown
FINAL_LR_FRAC = 0.075   # fine-tune warmdown floor above 0.07 sweet spot
...
model = torch.compile(model, dynamic=False)  # more steps in fixed wall-clock budget
...
def get_muon_momentum(step):
    frac = min(step / 180, 1)  # was 200; slightly faster Muon momentum ramp
