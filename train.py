...
class MLP(nn.Module):
    ...
    def forward(self, x):
        return self.c_proj(F.silu(self.gate_proj(x)) * self.up_proj(x))
...
ROPE_BASE = 50000.0     # BREAK: RoPE θ vs default 10k (500k run was unstable/killed)
...
MATRIX_LR = 0.0480      # learning rate for matrix parameters (Muon); GUARD +3.9% vs 0.0462
